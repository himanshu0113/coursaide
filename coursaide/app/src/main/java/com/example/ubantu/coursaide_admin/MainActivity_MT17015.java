...
public class MainActivity_MT17015 extends AppCompatActivity {
    private Button login_button,forgot_pass_button,admin_login_button, sign_up;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUser = (EditText) findViewById(R.id.student_username);
        mPass = (EditText) findViewById(R.id.student_password);
        ...
        sign_up.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), Sign_up_one_MT17015.class));
            }
        });
        ...
        {
            startActivity(new Intent(getApplicationContext(), View_Profile_MT17015.class));
            finish();
        }
        mAuth=FirebaseAuth.getInstance();
        ...
        //Code to Reset Password when Forgot Password option is clicked.
