...
public class SemesterCourses_MT17015 extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    SemesterCourse_fragment_clash_check_MT17015 tab1= new SemesterCourse_fragment_clash_check_MT17015();
                    return  tab1;
                case 1:
                    SemesterCourse_fragment_recomm_MT17015 tab2= new SemesterCourse_fragment_recomm_MT17015();
                    return tab2;
                default:
                    return null;
            }
